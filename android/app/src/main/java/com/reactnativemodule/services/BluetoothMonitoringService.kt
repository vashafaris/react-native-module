...
import com.reactnativemodule.Utils
import com.reactnativemodule.bluetooth.BLEAdvertiser
import com.reactnativemodule.bluetooth.gatt.ACTION_RECEIVED_STATUS
import com.reactnativemodule.bluetooth.gatt.ACTION_RECEIVED_STREETPASS
import com.reactnativemodule.bluetooth.gatt.STATUS
import com.reactnativemodule.bluetooth.gatt.STREET_PASS
...
import com.reactnativemodule.status.persistence.StatusRecordStorage
import com.reactnativemodule.streetpass.ConnectionRecord
import com.reactnativemodule.streetpass.StreetPassScanner
import com.reactnativemodule.streetpass.StreetPassServer
import com.reactnativemodule.streetpass.StreetPassWorker
import com.reactnativemodule.streetpass.persistence.StreetPassRecord
import com.reactnativemodule.streetpass.persistence.StreetPassRecordStorage
    ...
    inner class StreetPassReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (ACTION_RECEIVED_STREETPASS == intent.action) {
                ...
                Log.d("CEKVSHDTL", "onreceive" + connRecord.rssi)
                ...
                if (connRecord.msg.isNotEmpty()) {
                    ...
                    Log.d("CEK RECORD STAMP V", record.v.toString())
                    Log.d("CEK RECORD STAMP MSG", record.msg.toString())
                    Log.d("CEK RECORD STAMP ORG", record.org.toString())
                    Log.d("CEK RECORD STAMP MODELP", record.modelP.toString())
                    Log.d("CEK RECORD STAMP MODELC", record.modelC.toString())
                    Log.d("CEK RECORD STAMP RSSI", record.rssi.toString())
                    Log.d("CEK RECORD STAMP TXPOWER", record.txPower.toString())
